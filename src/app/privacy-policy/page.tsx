  ...
  return (
    <article className="flex flex-col justify-center items-center gap-10 py-7 mx-20">
      ...
      <section className="flex flex-col">
        <section>
          <h3 className="text-xl my-8">1 - Informações pessoais que coletamos</h3>
        ...
        <section>
          <h3 className="text-xl my-8">2 - Como usamos suas informações pessoais?</h3>
          <p className="text-lg my-4">
          ...
          <p className="text-lg my-4">Além disso, usamos essas Informações do pedido para:</p>
          <ul className="list-disc text-lg m-4">
        ...
        <section>
          <h3 className="text-xl my-8">3 - Menores de idade</h3>
          <p className="text-lg my-4">O Site não é destinado para pessoas com menos de 18 anos.</p>
        </section>

        <section>
          <h3 className="text-xl my-8">4 - Mudanças</h3>
          <p className="text-lg my-4">
