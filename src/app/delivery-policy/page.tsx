...
export default function DeliveryPolict() {
  return (
    <article className="flex flex-col justify-center items-center gap-10 py-7 mx-20">
      <h1 className="text-4xl lg:text-5xl ">Política de Entrega</h1>

      <section className="flex flex-col">
        <h2 className="text-3xl lg:text-4xl font-bold my-8">PRODUTO INTERNACIONAL</h2>

        <section>
          <h3 className="text-xl my-8">1 - Declaração de origem</h3>
        ...
        <section>
          <h3 className="text-xl my-8">2 - Prazo de entrega</h3>
          <p className="text-lg my-4">
        ...
        <section>
          <h3 className="text-xl my-8">3 - Prazo de processamento</h3>
          <p className="text-lg my-4">
        ...
        <section>
          <h3 className="text-xl my-8">4 - Formas de envio</h3>
          <p className="text-lg my-4">
        ...
        <section>
          <h3 className="text-xl my-8">5 - Confirmação de envio e código de rastreamento</h3>
          <p className="text-lg my-4">
